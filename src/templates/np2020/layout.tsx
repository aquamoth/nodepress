...
export default async (component: Promise<JSX.Element>, { publicPath, templatePath, renderModule, renderPartial }: RequestPipeline) => ({
            ...
            <body id="wordpress-org" className="repopackage-template-default single single-repopackage postid-25021 admin-bar no-customize-support modal-open">
                <div id="wporg-header">
                    <div className="wrapper">
                        ...
                        {await renderModule("menu", {name: "wporg-header-menu"})}
